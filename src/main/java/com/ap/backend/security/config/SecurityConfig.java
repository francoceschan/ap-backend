package com.ap.backend.security.config;

import com.ap.backend.security.jwt.JwtAuthEntryPoint;
import com.ap.backend.security.jwt.JwtRequestFilter;
import com.ap.backend.security.service.UserDetailsServiceImpl;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    CorsConfigurationSource corsConfigurationSource()
    {
        ...
        configuration.setAllowedOriginPatterns(List.of("http://localhost:4200", "https://ap-frontend.web.app/"));
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.cors().and().csrf().disable()
                ...
                .antMatchers("/api/experiencia").permitAll()
